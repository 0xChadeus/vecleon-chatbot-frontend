...
export default function Home() {
  ...
  const bgScroll = useTransform(scrollYProgress, [0, 1], [0, 0]);
  const infoScroll = useTransform(scrollYProgress, [0, 1], [0, -1300]);
  ...
  return (
    <>
      ...
      <motion.div className="bg-slate-950 h-screen sm:h-dvh" style={{y:infoScroll}}>
      ...
      <div className="container flex flex-col">
        <div className=" col-md-10 col-md-offset-1 section-title">
          ...
          <Button className='relative flex top-32 sm:top-52 font-extrabold text-lg' size={"lg"} variant={'outline'}> GET STARTED</Button>
        </div>
        </div>
      </div>
      </motion.div>
      ...
      <div className="container">
        <div className="col-md-10 col-md-offset-1 h-24 section-title">
        </div>
        <div className="row">
